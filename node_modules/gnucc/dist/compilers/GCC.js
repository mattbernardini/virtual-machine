...
function gcc(optOrInput, output, log = true) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof optOrInput === 'string') {
            ...
            if (optOrInput.binaries && optOrInput.binaries.gcc)
                binary = optOrInput.binaries.gcc;
            args.push(...Config_1.ProcessGccOpt(optOrInput));
